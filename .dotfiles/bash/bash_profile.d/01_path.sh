...
export PATH="${DOTFILES_HOME}/.dotfiles/bash/bin/user${PATH:+:${PATH}}"
export PATH="${DOTFILES_HOME}/.dotfiles/bash/${DOTFILES_TYPE}/shared/bin${PATH:+:${PATH}}"
export PATH="${DOTFILES_HOME}/.dotfiles/bash/${DOTFILES_TYPE}/user/bin${PATH:+:${PATH}}"
